 ...
 * @author theodora
 */
@WebServlet(urlPatterns = {"/setDoctor"})
public class setDoctor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PatientDB.setDoctor(patient, request.getParameter("doctor"));
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(setDoctor.class.getName()).log(Level.SEVERE, null, ex);
